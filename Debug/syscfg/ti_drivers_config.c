...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    /* Board_GPIO_DIO0_RESET */
    GPIOCC26XX_DIO_01 | GPIO_DO_NOT_CONFIG,
    /* Board_GPIO_DIO1_MFIO */
...
const uint_least8_t Board_GPIO_DIO0_RESET_CONST = Board_GPIO_DIO0_RESET;
const uint_least8_t Board_GPIO_DIO1_MFIO_CONST = Board_GPIO_DIO1_MFIO;
